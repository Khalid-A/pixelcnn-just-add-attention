...
import torch
from models.attpixelcnnpp import ConditionalAttPixelCNNpp
...
parser.add_argument("--n_resnet", type=int, default=5, help="number of layers for the attpixelcnn model")
...
parser.add_argument("--output_dir", type=str, default="outputs/attpixelcnn", help="directory to store the sampled outputs")
...
parser.add_argument("--model_checkpoint", type=str, default=None,
                    help="load model from checkpoint, model_checkpoint = path_to_your_att_pixel_cnn_model.pt")
...
if __name__ == "__main__":
    ...
    generative_model = ConditionalAttPixelCNNpp(embd_size=encoder.embed_size, img_shape=train_dataset.image_shape,
