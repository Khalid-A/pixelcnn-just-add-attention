...
class AttentionConv2d(nn.Module):
    def __init__(self, input_dim, output_dim, dk, dv, num_heads, kernel_size, padding, rel_encoding=True, height=None, width=None, norm='weight_norm'):
    ...
    def forward(self, input, input_padded):
        conv_out = self.conv_out(input_padded)
