...
import torch
from models.attcnnpp import ConditionalAttCNNpp
...
parser.add_argument("--n_resnet", type=int, default=5, help="number of layers for the attcnn model")
...
parser.add_argument("--output_dir", type=str, default="outputs/attcnn", help="directory to store the sampled outputs")
...
parser.add_argument("--model_checkpoint", type=str, default=None,
                    help="load model from checkpoint, model_checkpoint = path_to_your_att_cnn_model.pt")
...
def train(model, embedder, optimizer, scheduler,
    ...
    for epoch in range(opt.n_epochs):
        ...
        for i, (imgs, labels, captions) in enumerate(train_loader):
            ...
            torch.nn.utils.clip_grad_norm_(model.parameters(), 5.0) ## POSSIBLE SOLUTION TO ISSUE OF NAN TERMS
...
if __name__ == "__main__":
    ...
    generative_model = ConditionalAttCNNpp(embd_size=encoder.embed_size, img_shape=train_dataset.image_shape,
